...
with open('output.txt', 'w') as stdout, open('errors.txt', 'w') as stderr:
    with redirect_stdout(stdout), redirect_stderr(stderr):
        ...
        print("output testing", flush=True)
        ...
        async def handle_player_response(message: discord.Message, address):
            if message.content.lower() == 'yes':
                ...
                print(pending_responses, flush=True)
        ...
        async def start_server(interaction: discord.Interaction):
            ...
            try:
                ...
                print(f"Error in start server main function: {e}", flush=True)
        ...
        async def checkStatus(interaction: discord.Interaction):
            ...
            try:
                ...
                print(f"Error in check status main function: {e}", flush=True)
                await interaction.followup.send("An error occurred. Please try again.\n {e}")
        ...
        async def displayOnlinePlayers(interaction: discord.Interaction):
            ...
            try:
                ...
                print(f"Error in display online players main function: {e}", flush=True)
        ...
        if __name__ == "__main__":
            try:             
                ...
                print("Bot stopped and data saved.", flush=True)
            except Exception as e:
                ...
                save_linked_accounts(linked_accounts)
                save_correct_ip_addresses(get_correct_ips())
                print("Unexpected error occurred, data saved.", flush=True)
